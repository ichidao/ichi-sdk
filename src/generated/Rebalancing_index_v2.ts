...
export interface Rebalancing_index_v2Interface extends utils.Interface {
  functions: {
  ...
  events: {
    "DeployRebalanceStrategy(address,address,uint256,uint256)": EventFragment;
...
export interface Rebalancing_index_v2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Rebalancing_index_v2Interface;
  ...
  filters: {
    "DeployRebalanceStrategy(address,address,uint256,uint256)"(
