...
import type { IchiBnt, IchiBntInterface } from "../IchiBnt";
...
export class IchiBnt__factory {
  static readonly abi = _abi;
  static createInterface(): IchiBntInterface {
    return new utils.Interface(_abi) as IchiBntInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IchiBnt {
    return new Contract(address, _abi, signerOrProvider) as IchiBnt;
  }
}
