...
export class AlgebraIntegralPool__factory {
  static readonly abi = _abi;
  static createInterface(): AlgebraIntegralPoolInterface {
    return new utils.Interface(_abi) as AlgebraIntegralPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AlgebraIntegralPool {
    return new Contract(address, _abi, signerOrProvider) as AlgebraIntegralPool;
  }
}
