...
export class KeeperRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): KeeperRegistryInterface {
    return new utils.Interface(_abi) as KeeperRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): KeeperRegistry {
    return new Contract(address, _abi, signerOrProvider) as KeeperRegistry;
  }
}
