...
import type {
  Rebalancing_flip_v1,
  Rebalancing_flip_v1Interface,
} from "../Rebalancing_flip_v1";
...
const _abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum IFlipRebalanceManagerV1.RebalanceActions",
        name: "action",
        type: "uint8",
      },
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "increaseLiquidityPct",
        type: "uint256",
      },
    ],
    name: "SetIncreaseLiquidityPct",
    type: "event",
  },
  {
    anonymous: false,
...
export class Rebalancing_flip_v1__factory {
  static readonly abi = _abi;
  static createInterface(): Rebalancing_flip_v1Interface {
    return new utils.Interface(_abi) as Rebalancing_flip_v1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Rebalancing_flip_v1 {
    return new Contract(address, _abi, signerOrProvider) as Rebalancing_flip_v1;
  }
}
