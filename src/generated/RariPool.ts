...
export interface RariPoolInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "initialize(address,address,uint256,string,string,uint8,uint256,uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "initialize(address,address,address,string,string,uint256,uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
...
export interface RariPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RariPoolInterface;
