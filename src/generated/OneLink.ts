...
export interface OneLinkInterface extends utils.Interface {
  functions: {
    ...
    "addCollateral(address,uint256,address,bool)": FunctionFragment;
    "setCollateralMintFee(address,uint256)": FunctionFragment;
    "setReserveStepSize(uint256)": FunctionFragment;
    "setCollateralOracle(address,address,bool)": FunctionFragment;
...
export interface OneLink extends BaseContract {
