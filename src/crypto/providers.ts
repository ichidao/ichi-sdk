...
const getRpcEnvName = (chainId: ChainId): EnvUtils.EnvName => {
  switch (chainId) {
    ...
    case ChainId.Botanix:
      return EnvUtils.EnvName.BOTANIX_RPC_HOSTS;
    case ChainId.Bsc:
    ...
    case ChainId.Moonbeam:
      return EnvUtils.EnvName.MOONBEAM_RPC_HOSTS;
    case ChainId.Nibiru:
