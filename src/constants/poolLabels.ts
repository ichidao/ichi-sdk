...
export const PoolLabels: TPoolLabels = {
  [ChainId.Mainnet]: {
    ...
    [MainnetPoolNumbers.FXS_VAULT]: {
      ...
      farmAddress: ADDRESSES[AddressName.FARMING_V2][ChainId.Mainnet],
      farmId: 58,
      farmRewardTokenName: TokenName.FXS,
      farmRewardTokenDecimals: 18,
      farmRewardTokenAddress: getToken(TokenName.FXS, ChainId.Mainnet).address,
    ...
    [MainnetPoolNumbers.SHIB_VAULT]: {
      ...
      farmAddress: ADDRESSES[AddressName.FARMING_V2][ChainId.Mainnet],
      farmId: 59,
      farmRewardTokenName: TokenName.SHIB,
      farmRewardTokenDecimals: 18,
      farmRewardTokenAddress: getToken(TokenName.SHIB, ChainId.Mainnet).address,
    ...
    [MainnetPoolNumbers.METIS_VAULT]: {
      ...
      farmAddress: ADDRESSES[AddressName.FARMING_V2][ChainId.Mainnet],
      farmId: 60,
      farmRewardTokenName: TokenName.METIS,
      farmRewardTokenDecimals: 18,
      farmRewardTokenAddress: getToken(TokenName.METIS, ChainId.Mainnet).address,
    ...
    [MainnetPoolNumbers.UMA_VAULT]: {
      ...
      farmAddress: ADDRESSES[AddressName.FARMING_V2][ChainId.Mainnet],
      farmId: 61,
      farmRewardTokenName: TokenName.UMA,
      farmRewardTokenDecimals: 18,
      farmRewardTokenAddress: getToken(TokenName.UMA, ChainId.Mainnet).address,
    ...
    [MainnetPoolNumbers.BANK_VAULT]: {
      ...
      farmAddress: ADDRESSES[AddressName.FARMING_V2][ChainId.Mainnet],
      farmId: 62,
      farmRewardTokenName: TokenName.BANK,
      farmRewardTokenDecimals: 18,
      farmRewardTokenAddress: getToken(TokenName.BANK, ChainId.Mainnet).address,
    ...
    [MainnetPoolNumbers.FRAX_VAULT]: {
      ...
      farmAddress: ADDRESSES[AddressName.FARMING_V2][ChainId.Mainnet],
      farmId: 63,
      farmRewardTokenName: TokenName.FRAX,
      farmRewardTokenDecimals: 18,
      farmRewardTokenAddress: getToken(TokenName.FRAX, ChainId.Mainnet).address,
    ...
    [MainnetPoolNumbers.SFRXETH_VAULT]: {
      ...
      farmAddress: ADDRESSES[AddressName.FARMING_V2][ChainId.Mainnet],
      farmId: 64,
      farmRewardTokenName: TokenName.SFRXETH,
      farmRewardTokenDecimals: 18,
      farmRewardTokenAddress: getToken(TokenName.SFRXETH, ChainId.Mainnet).address,
