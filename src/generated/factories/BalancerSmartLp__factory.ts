...
import type {
  BalancerSmartLp,
  BalancerSmartLpInterface,
  ConfigurableRightsPool,
  RightsManager,
} from "../BalancerSmartLp";
...
export class BalancerSmartLp__factory {
  static readonly abi = _abi;
  static createInterface(): BalancerSmartLpInterface {
    return new utils.Interface(_abi) as BalancerSmartLpInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BalancerSmartLp {
    return new Contract(address, _abi, signerOrProvider) as BalancerSmartLp;
  }
}
