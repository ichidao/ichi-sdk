export enum MainnetPoolNumbers {
  ...
  PANCAKESWAP_SWETH_WETH_VAULT = 7012,
...
export enum PolygonPoolNumbers {
  ...
  QUICKSWAP_MATICX_WMATIC_VAULT = 7582,
  QUICKSWAP_USDC_A3A_VAULT = 7583,
  QUICKSWAP_USDC_WEFI_VAULT = 7584,
...
export enum ArbitrumPoolNumbers {
  ...
  RAMSES_FRAX_USDC_VAULT = 7729,
  RAMSES_FRXETH_WETH_VAULT = 7730,
  RAMSES_SFRAX_FRAX_VAULT = 7731,
  RAMSES_WETH_ERN_VAULT = 7732,
  RAMSES_WETH_OATH_VAULT = 7733,
}
...
export enum BscPoolNumbers {
  ...
  MUBI_WBNB_VAULT = 7924,
  ORDI_WBNB_VAULT = 7925,
  SATS_WBNB_VAULT = 7926,
  THENA_FRXETH_ETH_VAULT = 7927,
  THENA_FRAX_USDC_VAULT = 7928,
  THENA_HBR_USDT_VAULT = 7929,
  THENA_USDT_HBR_VAULT = 7930,
  THENA_WBNB_OATH_VAULT = 7931,
}
