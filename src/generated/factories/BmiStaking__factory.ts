...
import type { BmiStaking, BmiStakingInterface } from "../BmiStaking";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IBMIStaking",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    name: "getSlashedStakerBMIProfit",
    outputs: [
      {
        internalType: "uint256",
        name: "totalProfit",
  ...
  },
  {
    ...
    name: "withdrawStakerFundsWithProfit",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class BmiStaking__factory {
  static readonly abi = _abi;
  static createInterface(): BmiStakingInterface {
    return new utils.Interface(_abi) as BmiStakingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BmiStaking {
    return new Contract(address, _abi, signerOrProvider) as BmiStaking;
  }
}
