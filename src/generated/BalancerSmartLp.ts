...
export interface BalancerSmartLpInterface extends utils.Interface {
  functions: {
...
export interface BalancerSmartLp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerSmartLpInterface;
