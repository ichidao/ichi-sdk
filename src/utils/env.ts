...
export namespace EnvUtils {
  export enum EnvName {
    ...
    BOTANIX_RPC_HOSTS = 'BOTANIX_RPC_HOSTS',
    BSC_RPC_HOSTS = 'BSC_RPC_HOSTS',
    CELO_RPC_HOSTS = 'CELO_RPC_HOSTS',
    CRONOS_RPC_HOSTS = 'CRONOS_RPC_HOSTS',
    ...
    FLOW_RPC_HOSTS = 'FLOW_RPC_HOSTS',
    FLOW_TESTNET_RPC_HOSTS = 'FLOW_TESTNET_RPC_HOSTS',
    ...
    KATANA_RPC_HOSTS = 'KATANA_RPC_HOSTS',
    ...
    MONAD_RPC_HOSTS = 'MONAD_RPC_HOSTS',
    MONAD_TESTNET_RPC_HOSTS = 'MONAD_TESTNET_RPC_HOSTS',
    MOONBEAM_RPC_HOSTS = 'MOONBEAM_RPC_HOSTS',
  ...
  export enum GatsbyEnvName {
    ...
    GATSBY_BOTANIX_RPC_HOSTS = 'GATSBY_BOTANIX_RPC_HOSTS',
    GATSBY_BSC_RPC_HOSTS = 'GATSBY_BSC_RPC_HOSTS',
    GATSBY_CELO_RPC_HOSTS = 'GATSBY_CELO_RPC_HOSTS',
    GATSBY_CRONOS_RPC_HOSTS = 'GATSBY_CRONOS_RPC_HOSTS',
    ...
    GATSBY_FLOW_RPC_HOSTS = 'GATSBY_FLOW_RPC_HOSTS',
    GATSBY_FLOW_TESTNET_RPC_HOSTS = 'GATSBY_FLOW_TESTNET_RPC_HOSTS',
    ...
    GATSBY_KATANA_RPC_HOSTS = 'GATSBY_KATANA_RPC_HOSTS',
    ...
    GATSBY_MONAD_RPC_HOSTS = 'GATSBY_MONAD_RPC_HOSTS',
    GATSBY_MONAD_TESTNET_RPC_HOSTS = 'GATSBY_MONAD_TESTNET_RPC_HOSTS',
    GATSBY_MOONBEAM_RPC_HOSTS = 'GATSBY_MOONBEAM_RPC_HOSTS',
    ...
    GATSBY_TAC_RPC_HOSTS = 'GATSBY_TAC_RPC_HOSTS',
